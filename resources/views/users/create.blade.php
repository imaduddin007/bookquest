...
@section('content')
    <div class="col-12">
        ...
        @endif
        <form enctype="multipart/form-data" class="bg-white shadow-sm p-3 form-group" action="{{ route('users.store') }}"
            method="POST">
            @csrf
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input {{ $errors->first('roles') ? 'is-invalid' : '' }}" type="checkbox"
